define([], function(require) {
	...
	App.prototype = {
		init: function () {
			...
			TweenMax.to(this.camera, 1, {z: 2, delay: 1, onComplete: function () {
				$('#gameView').css('webkitTransform', 'none'); //force re-render for svg
				$('#gameView').css('transform', 'none'); //force re-render for svg
			}});
